    ...
    <div className="space-y-6" dir={isRTL ? 'rtl' : 'ltr'}>
        ...
        <CardContent className="p-6">
          <div className="space-y-2">
            ...
            <Textarea
              ...
              disabled={!isEditing}
              placeholder={t.structuralDescriptionPlaceholder}
              className="min-h-[120px] resize-y text-sm"
              dir={isRTL ? 'rtl' : 'ltr'}
            />
            <p className="text-[10px] text-gray-400">
              {t.structuralSystemDescription}
            </p>
          </div>
        </CardContent>
      </Card>
      ...
      <Card className="border-emerald-200/50 shadow-sm overflow-hidden">
        {sectionHeader(
          ...
          t.structuralSystemLabel,
          'from-emerald-500 to-teal-500'
        )}
        <CardContent className="p-6">
          <div className="space-y-2">
            <Label className="text-sm font-medium text-foreground/80">
              {t.structuralSystemType}
            </Label>
            <Select
            ...
            >
              <SelectTrigger className="w-full">
                <SelectValue placeholder={t.chooseStructuralSystem} />
              </SelectTrigger>
              <SelectContent>
          ...
          <div className="space-y-2">
            ...
            <div className="flex items-center gap-3">
              ...
              >
                ...
                {reportData.hammerTest.hammerReportPhoto ? t.uploaded : t.uploadPhoto}
              </Button>
      ...
      <Card className="border-emerald-200/50 shadow-sm overflow-hidden">
        ...
        <CardContent className="p-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
            {/* Soil Type */}
            <div className="space-y-2">
              <Label className="text-sm font-medium text-foreground/80">{t.soilType}</Label>
              <Input
                type="text"
            ...
            {/* Foundation Depth */}
            <div className="space-y-2">
              <Label className="text-sm font-medium text-foreground/80">{t.foundationDepth}</Label>
              <Input
                type="number"
            ...
            {/* Allowable Bearing */}
            <div className="space-y-2">
              <Label className="text-sm font-medium text-foreground/80">{t.soilBearingCapacity}</Label>
              <Input
                type="number"
            ...
            {/* Friction Angle */}
            <div className="space-y-2">
              <Label className="text-sm font-medium text-foreground/80">{t.soilFrictionAngle}</Label>
              <Input
                type="number"
            ...
            {/* Water Table Level */}
            <div className="space-y-2">
              <Label className="text-sm font-medium text-foreground/80">{t.groundwaterLevel}</Label>
              <Input
                type="number"
          ...
          <div className="mt-5 space-y-2">
            <Label className="text-sm font-medium text-foreground/80">{t.soilReportFile}</Label>
            <div className="flex items-center gap-3">
              <Button
                type="button"
                variant="outline"
              ...
              >
                ...
                {reportData.soilReport.soilReportFileName ? t.uploaded : t.uploadFile}
              </Button>
              <span className="text-[10px] text-gray-400">
                {t.maxFile20MB}
              </span>
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <div className="text-start">
                        <p className="text-sm font-semibold text-foreground">
                          {t.crackFloorLabel} {crack.floorNumber}
                        </p>
                        <p className="text-[10px] text-gray-400">
                          {t.structuralCrackNote}
                          {just.justification && (
                        ...
                        <div className="space-y-2">
                          ...
                          <div className="flex items-center gap-3">
                            ...
                            >
                              ...
                              {t.addPhotosLimit} ({just.additionalPhotos.length}/4)
                            </Button>
                            <span className="text-[10px] text-gray-400">{t.max1MBPerPhoto}</span>
                          </div>
                          <input
      ...
      <Card className="border-emerald-200/50 shadow-sm overflow-hidden">
        ...
        <CardContent className="p-6">
          <Textarea
            ...
            disabled={!isEditing}
            placeholder={t.structuralNotesPlaceholder}
            className="min-h-[120px] resize-y text-sm"
            dir={isRTL ? 'rtl' : 'ltr'}
          />
        </CardContent>
